...
### Associated presences — interpretive boundary
...
### No selectable outcome — limits on authorship
...
### The Talren Recursion — candidate anchor

Talren is the strongest candidate anchor for a full entry. It remains active in
the current era.

### Collection-frame impact — contamination reservation
