...
## Shared anchor institutions

| Entity | Type | Current role | Status |
| --- | --- | --- | --- |
| [First Quarry Houses](first-quarry-houses.md) | Guild federation | Industrial origin and early concealment of Rzez risk. | Provisional |
| [Compact Commission](compact-commission.md) | Investigative and regulatory body | Evaluates surviving instruments, sites, and evidence. | Provisional |
...
- **Concordant Temples:** authorities that prohibit the Severed God doctrine.
- **Crown Army of Merovar:** confirmed operator at Deren Keep.
- **Veyran League:** rival port-city coalition accused in the Glass Fleet event.
- **Marrowhouse Clinical Laboratory:** later-dissolved military medical facility.
- **Kharosi Assembly:** body before which Olan Vey is assassinated.
- **Forty-First Valec Commission:** source of the accepted Valec field record.
